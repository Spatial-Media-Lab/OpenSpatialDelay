...
- **21 output formats** -- Binaural, Stereo, Surround (Quad through 9.1.6), and Ambisonics (1st through 6th order)
...
| [Output Formats](output-formats.md) | All 21 output formats, rendering paths, and algorithm selection |
