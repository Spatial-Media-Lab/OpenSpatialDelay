...
description: Use when implementing spatial audio DSP in JUCE C++ plugins — VBAP, VBIP, KNN, Ambisonics HOA, DBAP, MDAP, Constant Power, or Direct Binaural. Covers HRTF/SOFA convolution, ADM-OSC, and spherical harmonics for VST3/AU. NOT for game middleware (use sound-engineer) or voice synthesis.
---
