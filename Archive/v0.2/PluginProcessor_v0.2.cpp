                                               ...
                                               juce::MidiBuffer& /*midi*/)
{
    ...
    // Flag: SH-domain HRTF path (Ambisonics bypasses speaker decode for binaural)
    bool useAmbiSH = (isBinaural && useHRTF && algo->supportsSHDomain());
