#!/bin/bash
# Post-build plugin installer for macOS - v0.1
# Called automatically by CMake after each build

PLUGIN_NAME="OpenSpatialDelay v0.1"
BUILD_DIR="$1"
AU_SRC="${BUILD_DIR}/OpenSpatialDelay_v01_artefacts/Release/AU/${PLUGIN_NAME}.component"
VST3_SRC="${BUILD_DIR}/OpenSpatialDelay_v01_artefacts/Release/VST3/${PLUGIN_NAME}.vst3"
